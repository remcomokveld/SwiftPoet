...
Finally, you’ll need to [integrate SwiftPoet into your project](https://github.com/gilt/SwiftPoet/blob/swift3/INTEGRATION.md) in order to use [the API](https://rawgit.com/gilt/SwiftPoet/swift3/Documentation/API/index.html) it provides.
...
See [the Integration document](https://github.com/gilt/SwiftPoet/blob/swift3/INTEGRATION.md) for additional details on integrating SwiftPoet into your project.
