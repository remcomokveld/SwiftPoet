...
**This is the `xcode-8.1` branch of SwiftPoet.** It uses **Swift 3.0.1** and **requires Xcode 8.1** to compile.
...
Once properly integrated, you can make use of [the API](https://rawgit.com/gilt/SwiftPoet/xcode-8.1/Documentation/API/index.html) provided by SwiftPoet using the statement:
...
Want to learn more about SwiftPoet? Check out [the README](https://github.com/gilt/SwiftPoet/blob/xcode-8.1/README.md) or [the API documentation](https://rawgit.com/gilt/SwiftPoet/xcode-8.1/Documentation/API/index.html).
